...
http.createServer((req, res) => {
	...
	switch (req.url) {
		...
		case '/':
			let homeText = 'Home \n '
			homeText += 'Bienvenidos a DH Movies el mejor sitio para encontrar las mejores películas, incluso mucho mejor que Netflix, Cuevana y PopCorn. \n\n';
			homeText += 'Cantidad de peliculas en cartel: ' + movies.length;
			
			titles = []
			movies.forEach(function(e, i){
				titles.push(e.original_title);
			});
			titles.sort();
